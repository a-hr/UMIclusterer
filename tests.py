...
if __name__ == "__main__":
    ...
    cmd_1 = f"python main.py {bam} -t {target_regions} | gzip > output/test_output.fastq.gz"
    cmd_2 = f"python main.py {bam} -t {target_regions_saf} -s | gzip > output/test_output_saf.fastq.gz"
